        ...
        <div className="container home-hero__grid">
          <div className="home-hero__copy">
            ...
            <h1 id="home-title" tabIndex="-1">
              Viva a cultura do seu jeito
            </h1>
            <p className="home-hero__lead">
              Eventos pensados para que mais pessoas possam chegar, participar e
              pertencer.
            </p>
            <div className="home-hero__actions">
              ...
              <Link className="button button--primary" to="/organizador/login">
                Sou organizador
              </Link>
            </div>
          </div>
      ...
      >
        <div className="container">
          ...
          <h2 id="home-intro-title">
            Experiências culturais mais próximas e plurais
          </h2>
          <p className="text-measure">
            Encontre encontros, espetáculos e celebrações com informações claras
            sobre acessibilidade antes de comprar.
          </p>
        </div>
      </section>
    </div>
